#!/usr/bin/env bash
#
# start-daemon.sh - Start all Nion development services in daemon mode
#
# This script starts Nion services in the background without keeping
...
echo ""
echo "=========================================="
echo " Starting Nion in Daemon Mode"
echo "=========================================="
echo ""
...
nohup sh -c 'cd "$1/frontend" && "$1/scripts/pnpm.sh" run dev > "$1/logs/frontend.log" 2>&1' _ "$REPO_ROOT" &
...
echo ""
echo "=========================================="
echo " Nion is running in daemon mode!"
echo "=========================================="
echo ""
