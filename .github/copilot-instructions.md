# Copilot Onboarding Instructions for Nion
...
Nion is a full-stack "super agent harness".
...
- `backend/packages/harness/nion/agents/` - lead agent, middleware chain, memory
- `backend/app/gateway/` - FastAPI gateway API
- `backend/packages/harness/nion/sandbox/` - sandbox provider + tool wrappers
- `backend/packages/harness/nion/subagents/` - subagent registry/execution
- `backend/packages/harness/nion/mcp/` - MCP integration
