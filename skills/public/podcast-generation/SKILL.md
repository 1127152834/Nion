...
```json
{
  ...
  "locale": "en",
  "lines": [
    {"speaker": "male", "paragraph": "Hello Nion! Welcome back to another episode."},
...
- Start with the male host saying a greeting that includes "Hello Nion"
...
```json
{
  ...
  "locale": "en",
  "lines": [
    {"speaker": "male", "paragraph": "Hello Nion! Welcome back to another fascinating episode. Today we're diving into something that's literally shaping our future - the history of artificial intelligence."},
...
The generated podcast follows the "Hello Nion" format:
- Two hosts: one male, one female
- Natural conversational dialogue
- Starts with "Hello Nion" greeting
