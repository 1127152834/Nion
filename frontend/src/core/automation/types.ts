...
export type AutomationJobKind = "reminder" | "scheduled_task" | "event_task" | "workflow";
...
export type AutomationRunStatus = "running" | "succeeded" | "failed" | "skipped" | "paused";
export type AutomationTriggerKind = "schedule" | "event" | "manual" | "webhook";
...
export type WorkflowStepKind =
  ...
  | "delay"
  | "wait_for_user";
export type AutomationTemplateScope = "official" | "personal";

export type AutomationVisibility = "private" | "shared" | "team";
...
export interface AutomationPlatformCapabilities {
  webhook_event_versions: string[];
  plugin_actions: string[];
}

export interface AutomationPlatformConnector {
  id: string;
  label: string;
  status: string;
}
