...
export const enUS: Translations = {
  ...
  agents: {
    ...
    nameStepNetworkError: "Could not reach the Nion backend.",
  ...
  workspace: {
    ...
    githubTooltip: "Open Nion on GitHub",
  ...
  settings: {
    ...
    memory: {
      ...
      factContentLabel: "Fact content",
      factCategoryLabel: "Category",
      factConfidenceLabel: "Confidence",
      factContentPlaceholder: "Describe the fact you want to persist",
      ...
      factValidationConfidence: "Confidence must be between 0 and 1.",
      manualFactSource: "Manual fact",
      importAction: "Import memory",
      exportAction: "Export memory",
      ...
      summaryCards: {
        factCount: "Fact memories",
        lastUpdated: "Recent update",
      ...
      recall: {
        ...
        emptyQuery: "Enter a query to view memory search results.",
        ...
        filterMemory: "Long-term memory",
        filterHistory: "Conversation history",
        openThread: "Open thread",
        resultsCount: (count: number) => `${count} results`,
        suggestProject: "Project changes",
        suggestPreference: "User preferences",
        suggestHistory: "Recent discussions",
