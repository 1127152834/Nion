...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    nameStepNetworkError: "无法连接到 Nion 后端。",
  ...
  workspace: {
    ...
    navigationMenu: "工作区",
    githubTooltip: "在 GitHub 上打开 Nion",
  ...
  settings: {
    ...
    memory: {
      ...
      recall: {
        ...
        searchButton: "检索",
        backToSearchHome: "返回检索首页",
        emptyQuery: "请输入关键词后查看搜索结果。",
        ...
        filterHistory: "历史对话",
        openThread: "打开原对话",
        resultsCount: (count: number) => `找到 ${count} 条相关结果`,
        suggestProject: "项目调整",
        suggestPreference: "用户偏好",
        suggestHistory: "最近讨论",
