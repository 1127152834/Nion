...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    channels: {
      title: "通道",
      description: "连接聊天应用，并管理谁可以通过这些通道使用 Nion。",
      workspace: {
        title: "当前应用",
        description:
          "通道授权会应用到当前 Nion 应用。",
      ...
      configuration: {
        title: "通道配置",
        description: "填写凭证并验证连通性，然后在同一页面处理配对和授权。",
      },
      labels: {
        enabled: "启用",
        disabled: "停用",
      ...
      fields: {
        ...
        botToken: "机器人 Token",
        allowedUsers: "允许用户",
        secretToken: "安全 Token",
      },
      hints: {
        pairingGuide:
          "通道已经可用。请让用户先发送任意一条消息，然后在下方批准该请求。",
        larkVerificationToken: "用于 Webhook challenge 校验，必填。",
        larkEncryptKey: "Lark 事件载荷的可选加密密钥。",
        dingtalkRobotCode: "钉钉 stream 模式走 robot-code 路由时必填。",
        dingtalkProxyMode: "控制运行时如何解析对外网络访问。",
        dingtalkWebhookUrl: "钉钉在回调模式下签发的 Webhook URL。",
      },
      actions: {
        setupDocs: "配置文档",
        testConnection: "测试连接",
      ...
      runtime: {
        statusTitle: "运行状态",
        statusDescription: "查看这个通道现在是否在线、是否连通，以及是否需要处理异常。",
      ...
      pairing: {
        sectionTitle: "连接用户",
        sectionDescription: "生成连接码、处理待连接请求，并管理已连接用户。",
        code: {
          title: "连接码",
          description:
            "建议先让用户发送任意消息。需要时，也可以让对方手动输入 `/pair 123456`。",
          expireMinutes: "分钟后过期",
          generateAction: "生成",
          activeCode: "当前连接码",
          noCodeGenerated: "尚未生成连接码",
          copiedToast: "已复制连接命令",
          generatedToast: "连接码已生成：{code}",
          generateFailed: "生成连接码失败",
          expiresAtPrefix: "过期时间",
          slotHint: "生成后会在这里显示 6 位连接码",
        },
        pending: {
          title: "待处理连接请求",
          empty: "暂无待处理连接请求",
      ...
      authorization: {
        ...
        revokeConfirmTemplate: '确认移除 "{name}" 的通道连接吗？该用户之后需要重新连接。',
        revokedToast: "连接已移除",
      },
      session: {
        defaultsTitle: "会话默认值",
        defaultsDescription: "为该通道设置默认会话参数，只有你主动填写的项才会提交。",
        assistantIdLabel: "助手 ID",
        assistantIdPlaceholder: "留空则继承默认值",
        recursionLimitLabel: "递归深度",
        recursionLimitPlaceholder: "留空则继承默认值",
        thinkingLabel: "深度思考",
        planModeLabel: "计划模式",
        subagentLabel: "子智能体",
        inheritOption: "继承",
        enabledOption: "启用",
        disabledOption: "停用",
        inheritLabel: "继承当前默认值",
        overrideDialogTitle: "编辑会话覆盖",
        overrideDialogDescription:
          "为已授权用户配置更高优先级的会话参数。留空或选择继承时，会回退到通道默认值。",
        overrideCurrentLabel: "当前覆盖值",
        resetAction: "重置为继承",
        savedToast: "会话覆盖已保存",
      },
      conversationTypes: {
      ...
      errors: {
        ...
        fillConnectionFieldsFirst: "请先填写用于连接测试的必填字段：{fields}",
        ...
        rejectFailed: "拒绝失败",
        revokeFailed: "撤销授权失败",
        sessionOverrideSaveFailed: "保存会话覆盖失败",
      },
    },
    skills: {
      title: "技能",
