...
const zhCN = {
  ...
  "bridge.overviewDiagnoseAction": "运行诊断",
  "bridge.overviewRestartAction": "重启 Bridge",
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  "bridge.overviewDiagnoseAction": "Run diagnostics",
  "bridge.overviewRestartAction": "Restart bridge",
