  ...
  return {
    ...
    supports_thinking:
      typeof item.supports_thinking === "boolean"
        ...
        : null,
    supports_vision:
      typeof item.supports_vision === "boolean" ? item.supports_vision : null,
    supports_video:
      typeof item.supports_video === "boolean" ? item.supports_video : null,
...
export function asCatalogModels(
...
export function getProviderProtocol(
  ...
  return normalizeProviderProtocol(
    asString(provider.protocol).trim() || inferProtocolFromUse(providerUse),
  );
}
...
function normalizeProviderList(
  ...
  return rawProviders.map((provider, index) => {
    ...
    const hasExplicitNameField = Object.prototype.hasOwnProperty.call(
      provider,
      "name",
    );
  ...
  return {
    ...
    supports_thinking:
      typeof model.supports_thinking === "boolean"
        ...
        : null,
    supports_vision:
      typeof model.supports_vision === "boolean" ? model.supports_vision : null,
    supports_video:
      typeof model.supports_video === "boolean" ? model.supports_video : null,
    context_window:
...
export function mergeModelMetadata(
  ...
  if (
    ...
    if (current.supports_reasoning_effort === undefined) {
      next.supports_reasoning_effort = metadata.supports_thinking;
    }
  }
  ...
  if (
    isFieldBlank(current.display_name) &&
    asString(metadata.name).trim() !== ""
  ) {
