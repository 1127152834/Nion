...
See: https://github.com/bytedance/nion/issues/1149
"""
...
class TestSerializeToolMessageContent:
    """NionClient._serialize_message should normalize ToolMessage content."""
...
class TestExtractText:
    """NionClient._extract_text should handle all content shapes."""
