...
# Make 'app' and 'nion' importable from any working directory
sys.path.insert(0, str(Path(__file__).parent.parent))

# Break the circular import chain that exists in production code:
#   nion.subagents.__init__
#     -> .executor (SubagentExecutor, SubagentResult)
#       -> nion.agents.thread_state
#         -> nion.agents.__init__
#           -> lead_agent.agent
#             -> subagent_limit_middleware
#               -> nion.subagents.executor  <-- circular!
#
# By injecting a mock for nion.subagents.executor *before* any test module
...
sys.modules["nion.subagents.executor"] = _executor_mock
