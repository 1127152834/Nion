...
from nion.community.infoquest import tools
from nion.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("nion.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("nion.community.infoquest.tools.get_app_config")
