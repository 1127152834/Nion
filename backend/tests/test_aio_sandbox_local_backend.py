from nion.community.aio_sandbox.local_backend import _format_container_mount


def test_format_container_mount_uses_mount_syntax_for_docker_windows_paths():
    args = _format_container_mount(
        "docker",
        "D:/nion/backend/.nion/threads",
        "/mnt/threads",
        False,
    )
    ...
    assert args == [
        "--mount",
        "type=bind,src=D:/nion/backend/.nion/threads,dst=/mnt/threads",
    ]
