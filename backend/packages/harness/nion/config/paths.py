...
class Paths:
    ...
    def host_base_dir(self) -> Path:
        ...
        Set NION_HOST_BASE_DIR to the host-side path that corresponds to this
        ...
        """
        if env := os.getenv("NION_HOST_BASE_DIR"):
            return Path(env)
    ...
    def delete_thread_dir(self, thread_id: str) -> None:
        """Delete all persisted data for a thread if it exists."""
