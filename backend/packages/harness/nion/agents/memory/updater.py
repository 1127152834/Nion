...
def import_memory_data(
    ...
    """Persist imported memory data via the active storage backend."""

    if not _save_memory_to_file(memory_data, agent_name, memory_storage):
        raise OSError("Failed to import memory data")
    return memory_data
