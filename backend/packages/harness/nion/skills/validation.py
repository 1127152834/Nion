...
def parse_and_validate_skill_frontmatter_text(
    ...
    return True, "Skill is valid!", normalized
...
def _validate_skill_frontmatter(skill_dir: Path) -> tuple[bool, str, str | None]:
    ...
    valid, message, frontmatter = parse_and_validate_skill_frontmatter_text(content)
    if not valid or frontmatter is None:
        return False, message, None
    return True, message, str(frontmatter["name"])
