...
def build_automation_runtime_config(job: AutomationJob, *, run_id: str, isolated_thread_id: str) -> dict[str, Any]:
...
class AutomationExecutor:
    def __init__(self, *, runtime_runner: AutomationRuntimeRunner, delivery_service: AutomationDeliveryService):
        self._runtime_runner = runtime_runner
        self._delivery_service = delivery_service

    def execute_job(self, job: AutomationJob, *, run_id: str) -> AutomationRun:
        started_at = _utcnow()
