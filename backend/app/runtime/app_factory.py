...
def create_runtime_app(
    *,
    ...
    for router in (
        ...
        cli.router,
        mcp.router,
        identity_document.router,
        knowledge.router,
        local_actions.router,
        memory_canonical.router,
        memory.router,
        memory_settings.router,
        memory_soul.router,
        memory_ledger.router,
        memory_evidence.router,
        memory_runtime_trace.router,
        notebook.router,
        recall.router,
        automation.router,
